...
function App() {
   ...
   let [student, setStudent] = useState({fname:'Viraj', lname:"Bhatti", city:"Rajkot"});
  
   let[fn, setFn] = useState("Yash");
   let[ln, setLn] = useState("Singal");
   let[ct, setCt] = useState("Baroda");
  return (
    <div className="App">
      <header className="App-header">
         ...
         {/* <StateDemo2></StateDemo2> */}
          ...
          {/* <button onClick={()=> setStudent({fname: "Viraj", lname:"Bhatti", city:"Rajkot"})}>Update</button> */}
